...
require("algorithms/graphs/strongly_connected_components")
require("data_structures/directed_graph")

describe(Algorithms::Graphs::StronglyConnectedComponents) {
  subject { Algorithms::Graphs::StronglyConnectedComponents.new(graph) }

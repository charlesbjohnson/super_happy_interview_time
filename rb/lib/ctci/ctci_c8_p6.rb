    ...
    module P6
      ...
      class JigSaw
        ...
        def first_open_edge(r, c)
          ...
          return r.pred, c if top&.none?
          return r, c.succ if right&.none?
          return r.succ, c if bottom&.none?
          return r, c.pred if left&.none?
        end
      end
